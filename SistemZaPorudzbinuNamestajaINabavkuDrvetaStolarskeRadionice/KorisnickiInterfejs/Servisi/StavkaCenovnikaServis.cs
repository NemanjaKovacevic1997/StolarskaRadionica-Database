...
namespace KorisnickiInterfejs.Servisi
{
    public class StavkaCenovnikaServis
    {
        ...
        public StavkaCenovnikaModel Citaj(int redniBrojStavke)
        {
            StavkaCenovnika modelDB = new StavkaCenovnika();
            modelDB = _repozitorijum.Get(new object[] { redniBrojStavke });
        ...
        {
            var kljuc = new object[] { int.Parse(modelUI.RedniBrojStavke) };
        ...
        public void Obrisi(int redniBrojStavke)
        {
            var kljuc = new object[] { redniBrojStavke };
